...
const filesPath = {
    src: {
        html: "src/components/forms/*.html",
        css: "src/components/sass/style.scss",
        js: "src/components/js/main.js",
        img: "src/components/img/**/*.*",
        fonts: "src/components/fonts/**/*.*",
        libs: "src/components/libs/**/*.*",
        favicon: "src/components/favicon.ico",
