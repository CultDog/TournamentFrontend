...
function EventSettings(){
    ...
    return(
        ...
        <Flex vertical gap = "middle">
            <div>
                    <Title level={2}>Редактирование мероприятия</Title>
                    <Breadcrumb
                        items={[
                        {
                            title: 'Мероприятия',
            ...
            >
                <Flex vertical align="center">
                    <Title level={3}>Данные мероприятия</Title>
                </Flex>
                <FormItem
                    name="event_name"
                    hasFeedback
                ...
                >
                    <Flex vertical>
                    <Text>Название мероприятия</Text>
                    <Input
                        allowClear
            ...
            <Space direction="vertical" size = "middle">
                <Flex vertical align="center">
                    <Title level={3}>Компетенции</Title>
                </Flex>
